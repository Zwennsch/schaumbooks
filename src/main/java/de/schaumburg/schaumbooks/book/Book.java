...
public class Book {
    ...
    public Book(Long id, String title, String verlag, String isbn, BookStatus status, Person person) {
        this.id = id;
        this.title = title;
        this.verlag = verlag;
        this.isbn = isbn;
    ...
    public String toString() {
        return "Book [id=" + id + ", title=" + title + ", verlag=" + verlag + ", isbn=" + isbn + ", status=" + status
                + ", user=" + person + "]";
    }
